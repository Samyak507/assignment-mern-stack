...
import { fetchProducts, setCategory, setSort, setSearch, setPage } from '../../../productsSlice';
...
const initialState = {
  ...
  content : 'This is the new product available',
  category: '',
  _id: ''
}
  ...
  return (
    ...
    <div className="upload">
      ...
      <div id="file_img" style={styleUpload}>
        <img src={images ? images.url : ''} alt="upload" />
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="row">
        ...
        <select name="category" id={product.category} onChange ={handleChangeInput}>
